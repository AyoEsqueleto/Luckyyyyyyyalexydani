(function () {
  ...
  function createPreferencesModal() {
    ...
    backdrop.innerHTML = [
      ...
      '<p>Configura que cookies permites. Puedes consultar el detalle legal en nuestra <a href="cookie-policy/" style="color:#1565ff;font-weight:600;">Politica de Cookies</a>.</p>',
      ...
      '</label>',
      '</div>',
      '<div class="cc-cookie-desc"><a href="cookie-policy/#csrf-token" style="color:#1565ff;font-weight:700;text-decoration:none;">Privacy policy</a><br>Protects against hacking and malicious actors.<br><strong>Type:</strong> http_cookie · <strong>Duration:</strong> 29 days</div>',
      '</div>',
      '<div class="cc-cookie-item">',
      '<div class="cc-cookie-row">',
